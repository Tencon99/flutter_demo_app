...
import 'package:unicorn_app/core/widget/list/list_item.dart';
                      ...
                      child: Column(
                        children: <Widget>[
                          ListItem(
                            ...
                            describe: 'huangtengqingjys',
                            describeColor: Colors.white,
                            onPressed: () {
                              launch('https://github.com/huangtengqingjys');
                            },
                          ),
                          ListItem(
                            icon: Icon(
                          ...
                          ListItem(
                            ...
                            titleColor: Colors.white,
                            describe:
                                'https://github.com/huangtengqingjys/unicorn_app',
                            describeColor: Colors.white,
                            onPressed: () {
                              launch(
                                  'https://github.com/huangtengqingjys/unicorn_app');
