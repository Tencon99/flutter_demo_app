...
import 'package:unicorn_app/core/utils/path.dart';
  ...
  static void handleError(DioError e) {
    switch (e.type) {
      case DioErrorType.connectTimeout:
        print("连接超时");
        developer.log('出现报错！', name: '连接超时');
        break;
      case DioErrorType.sendTimeout:
        print("请求超时");
        developer.log('出现报错！', name: '请求超时');
        break;
      case DioErrorType.receiveTimeout:
        print("响应超时");
        developer.log('出现报错！', name: '响应超时');
        break;
      case DioErrorType.response:
        print("出现异常");
        developer.log('出现报错！', name: '出现异常');
        break;
      case DioErrorType.cancel:
        print("请求取消");
        developer.log('出现报错！', name: '请求取消');
        break;
      default:
        print("未知错误");
        developer.log('出现报错！', name: '未知错误');
        break;
    }
  }
